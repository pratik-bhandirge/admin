odoo.define('maqabim_website.maqabim_website_popup', function (require) {
    "use strict";
...
ajax.loadXML('/maqabim_website/static/src/xml/maqabim_website_popup.xml', qweb).then(function() {
    var status_welcome = $(qweb.render("maqabim_website.status_welcome", {'website': $('html').data('website-id'), 'company': $('html').data('oe-company-name')}));
    ...
    $('#age_modal_exit').bind('click', function(){
      ...
      window.location.href = "https://www.google.com/search?q=Maqabim Distributors Ltd";
    })
