    ...
    def get_reconciliation_proposition(self, excluded_ids=None):
        ...
        if not aml_search:
            ...
            for dt_bef in date_maturity_before_range_list:
                date_maturity_bef = datetime.strftime(date_maturity - timedelta(dt_bef), '%Y-%m-%d')
                date_maturity_bef = datetime.strptime(date_maturity_bef, "%Y-%m-%d")
                date_maturity_before_date_list.append(date_maturity_bef)
            for dt_aft in date_maturity_after_range_list:
                date_maturity_aft = datetime.strftime(date_maturity + timedelta(dt_aft), '%Y-%m-%d')
                date_maturity_aft = datetime.strptime(date_maturity_aft, "%Y-%m-%d")
